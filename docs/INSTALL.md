...
[0.13.1 prototype](https://github.com/huntergdavis/poolrad-macmaps/releases/tag/v0.13.1)
...
1. **Get the APK onto the tablet.** Download
   [`poolrad-macmaps-0.13.1.apk`](https://github.com/huntergdavis/poolrad-macmaps/releases/download/v0.13.1/poolrad-macmaps-0.13.1.apk)
