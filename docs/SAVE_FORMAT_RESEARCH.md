> Historical research from 2026-09-18. Claims about other projects and the
> then-current implementation are preserved as research history, not a current
> survey. The verified Macintosh specification is [SAVE_FORMAT.md](SAVE_FORMAT.md);
> current authorization and feature status are in DESIGN.md and BACKLOG.md.
