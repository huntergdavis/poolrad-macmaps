...
[0.113.0 prototype](https://github.com/huntergdavis/poolrad-macmaps/releases/tag/v0.113.0)
...
1. **Get the APK onto the tablet.** Download
   [`poolrad-macmaps-0.113.0.apk`](https://github.com/huntergdavis/poolrad-macmaps/releases/download/v0.113.0/poolrad-macmaps-0.113.0.apk)
